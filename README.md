...
Following are the current latest versions of supported HPC/AI VM images that are available in Azure Marketplace, with the exception of Azure Linux (only available from Azure CLI for MSFT internal):
