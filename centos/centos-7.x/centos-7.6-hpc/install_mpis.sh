...
# HPC-X v2.8.0
HPCX_VERSION="v2.8.0"
HPCX_DOWNLOAD_URL=https://azhpcstor.blob.core.windows.net/azhpc-images-store/hpcx-v2.8.0-gcc9.2.0-MLNX_OFED_LINUX-5.2-1.0.4.0-redhat7.6-x86_64.tbz
TARBALL=$(basename ${HPCX_DOWNLOAD_URL})
HPCX_FOLDER=$(basename ${HPCX_DOWNLOAD_URL} .tbz)

$COMMON_DIR/download_and_verify.sh $HPCX_DOWNLOAD_URL "27b2843377ecec8a42f4142f3c6c50f43a96c290942d08a7b9b7b4d83925e921"
tar -xvf ${TARBALL}
