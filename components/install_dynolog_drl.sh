...
ExecStart=/opt/dynolog/bin/dynolog -enable_ipc_monitor=true -enable_gpu_monitor=true -kernel_monitor_reporting_interval_s=10 -dcgm_lib_path=/usr/lib/libdcgm.so -dcgm_reporting_interval_s=10 -use_udsrelay=true -dcgm_fields="100,155,204,1001,1005,1008,1009,1010,1011,1012,1013,1014"
Restart=always
RestartSec=60s
User=root
Group=root
