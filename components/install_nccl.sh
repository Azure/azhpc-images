...
if [[ $DISTRIBUTION == *"ubuntu"* ]]; then
    ...
    pushd build/pkg/deb/
    dpkg_install_with_lock_wait "libnccl2_${NCCL_VERSION}+cuda${CUDA_DRIVER_VERSION}_${ARCHITECTURE_DISTRO}.deb"
    apt-mark hold libnccl2
    dpkg_install_with_lock_wait "libnccl-dev_${NCCL_VERSION}+cuda${CUDA_DRIVER_VERSION}_${ARCHITECTURE_DISTRO}.deb"
