...
MOFED_VERSION_CENTOS_83="MLNX_OFED_LINUX-5.8-1.0.1.1"
...
HPCX_OMB_PATH_CENTOS_83="/opt/hpcx-v2.13-gcc-MLNX_OFED_LINUX-5-redhat8-cuda11-gdrcopy2-nccl2.12-x86_64/ompi/tests/osu-micro-benchmarks-5.8"
MODULE_FILES_ROOT_CENTOS="/usr/share/Modules/modulefiles"
IMPI2021_PATH_CENTOS="/opt/intel/oneapi/mpi/${IMPI_2021_VERSION_CENTOS}"
IMPI2021_PATH_CENTOS_83="/opt/intel/oneapi/mpi/${IMPI_2021_VERSION_CENTOS_83}"
MVAPICH2_PATH_CENTOS="/opt/mvapich2-${MVAPICH2_VERSION_CENTOS}"
MVAPICH2_PATH_CENTOS_83="/opt/mvapich2-${MVAPICH2_VERSION_CENTOS_83}"
...
OPENMPI_PATH_CENTOS_83="/opt/openmpi-${OMPI_VERSION_CENTOS_83}"
...
if [[ $distro == *"Ubuntu"* ]] || [[ $distro == "CentOS Linux 8.3.2011" ]] || [[ $distro == "AlmaLinux 8.6" ]]
then
...
then
    ...
    CHECK_MVAPICH2X=0
    MODULE_FILES_ROOT=${MODULE_FILES_ROOT_CENTOS}
    MOFED_VERSION=${MOFED_VERSION_CENTOS_83}
    IMPI2021_PATH=${IMPI2021_PATH_CENTOS_83}
    MVAPICH2_PATH=${MVAPICH2_PATH_CENTOS_83}
    OPENMPI_PATH=${OPENMPI_PATH_CENTOS_83}
