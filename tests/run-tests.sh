...
CENTOS_MOFED_VERSION_79="MLNX_OFED_LINUX-5.2-2.2.3.0"
...
HPCX_OMB_PATH_CENTOS_79="/opt/hpcx-v2.8.3-gcc-${CENTOS_MOFED_VERSION_79}-redhat7.9-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
