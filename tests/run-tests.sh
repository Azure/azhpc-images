...
CENTOS_IMPI2021_PATH="/opt/intel/oneapi/mpi/${IMPI_2021_VERSION}"
...
HPCX_OMB_PATH_UBUNTU_1804="/opt/hpcx-${HPCX_VERSION}-gcc-${UBUNTU_MOFED_VERSION}-ubuntu18.04-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
HPCX_OMB_PATH_UBUNTU_2004="/opt/hpcx-${HPCX_VERSION}-gcc-${UBUNTU_MOFED_VERSION}-ubuntu20.04-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
