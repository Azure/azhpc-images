...
CENTOS_MOFED_VERSION="MLNX_OFED_LINUX-5.2-2.2.3.0"
CENTOS_MOFED_VERSION_83="MLNX_OFED_LINUX-5.2-1.0.4.0"
HPCX_OMB_PATH_CENTOS_76="/opt/hpcx-v2.8.3-gcc-${CENTOS_MOFED_VERSION}-redhat7.6-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
HPCX_OMB_PATH_CENTOS_77="/opt/hpcx-v2.8.3-gcc-${CENTOS_MOFED_VERSION}-redhat7.7-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
HPCX_OMB_PATH_CENTOS_78="/opt/hpcx-v2.8.3-gcc-${CENTOS_MOFED_VERSION}-redhat7.8-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
HPCX_OMB_PATH_CENTOS_79="/opt/hpcx-v2.8.3-gcc-${CENTOS_MOFED_VERSION}-redhat7.9-x86_64/ompi/tests/osu-micro-benchmarks-5.6.2"
